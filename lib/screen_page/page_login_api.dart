...
import 'package:latihan_6april/model/ModelLogin.dart';
import 'package:latihan_6april/screen_page/page_bottom_navigation.dart';
import 'package:http/http.dart' as http;
import 'package:latihan_6april/screen_page/page_register_api.dart';
  ...
  Future<void> loginAccount() async {
    try {
      ...
      final http.Response response = await http.post(
        Uri.parse('http://192.168.243.79/edukasi_server/login.php'),
        body: {
