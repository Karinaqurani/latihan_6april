...
import 'package:latihan_6april/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http.get(
        Uri.parse("http://192.168.243.79/edukasi_server/getBerita.php"),
      );
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'http://192.168.243.79/edukasi_server/gambar_berita/${data.gambar}',
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                Padding(
