...
import 'package:latihan_6april/screen_page/page_bottom_navigation.dart';
import 'package:latihan_6april/screen_page/page_update_pegawai.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://192.168.243.79/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://192.168.243.79/edukasi_server/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://192.168.243.79/edukasi_server/simpanPegawai.php'),
                        body: dataPegawai,
                      ).then((response) {
                        // Memeriksa respons dari server
                        if (response.statusCode == 200) {
